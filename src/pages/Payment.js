    ...
    try {
      ...
      const paymentGatewayURL =
        paymentData.gatewayType === "muscat"
          ...
          const redirectURL = `${paymentGatewayURL}?amount=${paymentData.amount}&order_id=${paymentData.order_id}&currency=${paymentData.currency}&gatewayType=${paymentData.gatewayType}`;
